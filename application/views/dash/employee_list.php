...
<html lang="en">
  ...
  <body>
		...
		<div class="row">
			...
			<div class="col-md-9">
				<table class="table table-bordered">
					...
					<?php 
					$employee_list = $this->db->get('employee');
	...
	<tr>
		...
		<td><a href="<?php echo site_url(); ?>employees/single_employee/<?php echo $employee->e_id; ?>" class="btn btn-success btn-block btn-xs">Details</a></td>
